...
__bpf_kfunc void *bpf_rdonly_obj_cast(void *obj__ign, u32 btf_id__k)
{
	return obj__ign;
}

__bpf_kfunc u64 bpf_scalar_cast(u64 any__ign)
{
	return any__ign;
}
...
BTF_ID_FLAGS(func, bpf_iter_loop_new, KF_ITER_NEW)
BTF_ID_FLAGS(func, bpf_iter_loop_next, KF_ITER_NEXT | KF_RET_NULL)
BTF_ID_FLAGS(func, bpf_iter_loop_destroy, KF_ITER_DESTROY)
